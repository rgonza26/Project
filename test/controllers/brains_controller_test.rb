...
class BrainsControllerTest < ActionController::TestCase
  ...
  test "should create brain" do
    assert_difference('Brain.count') do
      post :create, brain: { date: @brain.date, description: @brain.description, image: @brain.image, name: @brain.name }
    end
  ...
  test "should update brain" do
    patch :update, id: @brain, brain: { date: @brain.date, description: @brain.description, image: @brain.image, name: @brain.name }
    assert_redirected_to brain_path(assigns(:brain))
  end
